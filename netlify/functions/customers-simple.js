...
// netlify/functions/customers-simple.ts
var customers_simple_exports = {};
__export(customers_simple_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(customers_simple_exports);
