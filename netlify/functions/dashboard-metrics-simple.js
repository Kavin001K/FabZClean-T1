...
// netlify/functions/dashboard-metrics-simple.ts
var dashboard_metrics_simple_exports = {};
__export(dashboard_metrics_simple_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(dashboard_metrics_simple_exports);
...
var sampleData = {
  orders: [
    ...
    },
    {
      ...
      pickupDate: "2024-01-17",
      dueDate: "2024-01-18",
      // 1 day after pickup (express service)
  ...
  customers: [
    {
      ...
      lastOrder: (/* @__PURE__ */ new Date()).toISOString()
    },
    {
      id: "2",
      name: "Jane Smith",
...
var db = {
  ...
  async getOrdersByDueDate(daysAhead = 7) {
    try {
      ...
      return sampleData.orders.filter((order) => {
        ...
        return dueDate >= today && dueDate <= futureDate && ["pending", "processing", "ready"].includes(order.status);
  ...
  async testConnection() {
    try {
      return { connected: true, time: (/* @__PURE__ */ new Date()).toISOString() };
    } catch (error) {
