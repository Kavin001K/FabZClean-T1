...
(async () => {
    ...
    try {
        ...
        (0, vite_1.log)("✅ SQLite database initialized and connected");
    }
    catch (error) {
        (0, vite_1.log)("❌ Database initialization failed:", error);
        // Don't exit - allow app to start even if DB init fails
        (0, vite_1.log)("⚠️  Continuing without database initialization...");
    }
