              ...
              <Card className="border-2">
                ...
                <CardContent>
                  <div className="text-xl font-bold text-green-600">
                    Rs. {formatINR(data.revenue?.totalRevenue || 0)}
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="border-2">
                ...
                <CardContent>
                  <div className="text-xl font-bold text-blue-600">
                    Rs. {formatINR(data.grossProfit || 0)}
                  </div>
              ...
              <Card className="border-2">
                ...
                <CardContent>
                  <div className="text-xl font-bold text-purple-600">
                    Rs. {formatINR(data.operatingIncome || 0)}
                  </div>
                  <p className="text-xs text-muted-foreground mt-1">
              ...
              <Table>
                ...
                <TableBody>
                    ...
                    <>
                      ...
                      <TableRow className="bg-muted/50 font-bold border-t">
                        ...
                        <TableCell className="text-right text-red-600">
                          Rs. {formatINR(data.costOfGoodsSold?.totalCOGS || 0)}
                        </TableCell>
                      </TableRow>
                  ...
                  <TableRow className="bg-muted/50 font-bold border-t">
                    ...
                    <TableCell className="text-right text-red-600">
                      Rs. {formatINR(data.operatingExpenses?.totalOperatingExpenses || 0)}
                    </TableCell>
                  </TableRow>
