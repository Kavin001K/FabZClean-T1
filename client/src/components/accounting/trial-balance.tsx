                ...
                {!data.isBalanced && (
                  <div className="text-right">
                    ...
                    <p className="text-lg font-bold text-red-600">
                      Rs. {formatINR(Math.abs((data.totalDebit ?? 0) - (data.totalCredit ?? 0)))}
                    </p>
                  </div>
                )}
              </div>
              ...
              <Table>
                ...
                <TableBody>
                      ...
                      <React.Fragment key={type}>
                        ...
                        <TableRow className="bg-muted/30 font-semibold text-sm">
                          ...
                          <TableCell className="text-right">
                            Rs. {formatINR(typeDebit)}
                          </TableCell>
                          <TableCell className="text-right">
                            Rs. {formatINR(typeCredit)}
                          </TableCell>
                        </TableRow>
                      </React.Fragment>
                    );
                  ...
                  <TableRow className="bg-primary/10 font-bold border-t-2">
                    ...
                    Rs. {formatINR(data.totalDebit ?? 0)}
                    </TableCell>
                    <TableCell className="text-right text-red-600">
                    Rs. {formatINR(data.totalCredit ?? 0)}
                    </TableCell>
                  </TableRow>
                </TableBody>
              </Table>
              ...
              <Card>
                ...
                <CardContent>
                  <div className="text-2xl font-bold text-green-600">
                                          Rs. {formatINR(data.totalDebit ?? 0)}                  </div>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent>
                  <div className="text-2xl font-bold text-red-600">
                                          Rs. {formatINR(data.totalCredit ?? 0)}                  </div>
                </CardContent>
              </Card>
