...
export const orders = pgTable("orders", {
  ...
  expressCharge: decimal("express_charge", { precision: 10, scale: 2 }).default("0"),
  instantCharge: decimal("instant_charge", { precision: 10, scale: 2 }).default("0"),
  statusTimestamps: jsonb("status_timestamps").default({}),
...
export const insertOrderSchema = z.object({
  ...
  expressCharge: z.union([z.string(), z.number()]).transform(val => val.toString()).optional().nullable(),
  instantCharge: z.union([z.string(), z.number()]).transform(val => val.toString()).optional().nullable(),
  statusTimestamps: z.any().optional().nullable(),
